...
impl Contract {
    ...
    pub fn new_default_meta(owner_id: AccountId) -> Self {
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "AfroRick NFT Token for TestNet".to_string(),
                symbol: "AFRO".to_string(),
    ...
    pub fn token_metadata() -> TokenMetadata {
        TokenMetadata {
            title: Some("AfroRick Limited Edition".into()),
            description: Some("Limited Edition original AfroRick collectible - can be burned for something useful in the future ;)".into()),
            media: Some("https://bafkreianjcfwgbyo57jqvioikuhdo2xlpb5pv5p4h5v6glpbyecaxhzxgq.ipfs.nftstorage.link/".to_string()),
            media_hash: None,
            copies: Some(1u64),
            issued_at: None,
            expires_at: None,
    ...
    pub fn nft_mint_default(
        ...
        self.tokens.internal_mint(token_id, receiver_id, Some(
            ...
            TokenMetadata {
                title: Some("AfroRick Limited Edition".into()),
                description: Some("Limited Edition original AfroRick collectible - can be burned for something useful in the future ;)".into()),
                media: Some("https://bafkreifm7wokjo2l7ms2nlflbzkzyhudhc3so5gisfujjz7r2uh6los3ey.ipfs.nftstorage.link/".to_string()),
                media_hash: None,
                copies: Some(1u64),
                issued_at: None,
                expires_at: None,
